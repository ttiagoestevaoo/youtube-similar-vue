<template>
  <div>
    <div class="bc-videos">
      <SearchVideoCard v-for="(video, index) in getVideosList" :key="index" :video="video"/>
    </div>
  </div>
</template>
...
const searchVideos = async() => {
  const search = router.currentRoute.value.query.search ? router.currentRoute.value.query.search.toString() : ""
